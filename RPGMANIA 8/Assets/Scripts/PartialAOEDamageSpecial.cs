...
{
    [CreateAssetMenu(fileName = "Special Attack", menuName = "Special Attack/Partial AOE")]
    public class PartialAOEDamageSpecial : SpecialAttacks
    {
        ...
        public void Damage(List<EntityBase> entities) 
        {
            ...
            {
                entities[i].OnDamageTaken(BaseValue);
            }
        }
    }
}